...
var sandbox={encodeURIComponent:encodeURIComponent,String:String,Number:Number};
...
assert.strictEqual(api.licenseAllowsSpatial(track({license:'CC BY-NC 4.0'})),true,'noncommercial licenses may allow derivatives');
...
assert.strictEqual(api.licenseAllowsSpatial(track({license:''})),true,'blank alternative license falls back to Audius OML/API access');
