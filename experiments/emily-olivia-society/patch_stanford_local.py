...
def patch_gpt() -> None:
    ...
    # community member. The pinned BitNet llama-server exposes the documented
    # OpenAI-compatible chat-completions route, which applies the model's native
    # chat template internally. Keep Stanford's complete instruction unchanged
    # and place it alone in the system role, with no generic assistant persona.
