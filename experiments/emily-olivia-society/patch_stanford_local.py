...
def patch_gpt() -> None:
    ...
    # Replace Stanford's external generation section as one unit while keeping
    # its public chat_safe_generate helper. Every generation request goes to
    # the already-loaded localhost llama-server using the model's own chat
    # template through the OpenAI-compatible endpoint.
